...
| `ATTRIBUTION.md` | OSS license attribution | Generated by `attribution-gen --modfile go.mod --output ATTRIBUTION.md` ([source](https://github.com/awslabs/attribution-gen)). Regenerate whenever `go.mod`/`go.sum` changes |
